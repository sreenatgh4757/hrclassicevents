        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-warm-gray mb-8 leading-relaxed">
              From the first idea to the last dance, HR Classic Events takes care of 
              every detail. Whether it’s an elegant wedding, a corporate gala, or a 
              private celebration, our expert planning ensures your special day is 
              stress-free, stunning, and unforgettable.
            </p>
            <Button
              asChild
